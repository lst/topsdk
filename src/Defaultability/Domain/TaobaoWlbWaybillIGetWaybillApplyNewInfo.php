...
class TaobaoWlbWaybillIGetWaybillApplyNewInfo {
     ...
     **/
    private $consignee_branch_code;

    /**
        包裹对应的派件（收件）物流服务商网点（分支机构）名称
     **/
    private $consignee_branch_name;

    /**
        集包地代码
     **/
    private $package_center_code;

    /**
        集包地名称
     **/
    private $package_center_name;
     ...
     **/
    private $shipping_branch_code;

    /**
        面单号对于的物流服务商网点（分支机构）名称
     **/
    private $shipping_branch_name;
